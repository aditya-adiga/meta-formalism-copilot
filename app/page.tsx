...
export default function Home() {
  ...
  const {
    ...
    customArtifactTypes, addCustomArtifactType, updateCustomArtifactType, removeCustomArtifactType,
    customArtifactData, setCustomArtifactContent,
  ...
  }, [selectNode, updateNode, setSemiformalText, setLeanCode, setVerificationStatus, setVerificationErrors, setSemiformalDirty, setPersistedCausalGraph, setPersistedStatisticalModel, setPersistedPropertyTests, setPersistedDialecticalMap, setPersistedCounterexamples, setCustomArtifactContent]);
  ...
  }, [updateSessionArtifact, updateNode, decomp.nodes, setPersistedCausalGraph, setPersistedStatisticalModel, setPersistedPropertyTests, setPersistedDialecticalMap, setPersistedCounterexamples, setCustomArtifactContent]);
